/* Generated by scripts/gen-case-fold.py (Unicode 15.0.0). Do not edit. */
#ifndef CASE_FOLD_H
#define CASE_FOLD_H

#include <stdint.h>

/* Sorted by [0]: a cased BMP codepoint -> its single lowercase fold.
 * ASCII is folded inline; multi-character folds are omitted (simple
 * folding), as is anything outside the BMP. */
static const uint16_t CASE_FOLD[][2] = {
    ...
    {0x012C, 0x012D}, {0x012E, 0x012F}, {0x0132, 0x0133}, {0x0134, 0x0135},
    ...
    {0x0178, 0x00FF}, {0x0179, 0x017A}, {0x017B, 0x017C}, {0x017D, 0x017E},
    ...
    {0x024A, 0x024B}, {0x024C, 0x024D}, {0x024E, 0x024F}, {0x0370, 0x0371},
    {0x0372, 0x0373}, {0x0376, 0x0377}, {0x037F, 0x03F3}, {0x0386, 0x03AC},
...
#define CASE_FOLD_COUNT (sizeof(CASE_FOLD) / sizeof(CASE_FOLD[0]))
